...
# Hyperparameters
batch_size = hyperparameters['batch_size']  # How many batches per training step
context_length = hyperparameters['context_length']  # Length of the token chunk each batch
d_model = hyperparameters['d_model']  # The size of our model token embeddings
num_blocks = hyperparameters['num_blocks']  # Number of transformer blocks
num_heads = hyperparameters['num_heads']  # Number of heads in Multi-head attention
learning_rate = hyperparameters['learning_rate']  # 0.001
dropout = hyperparameters['dropout']  # Dropout rate
max_iters = hyperparameters['max_iters']  # Total of training iterations <- Change this to smaller number for testing
eval_interval = hyperparameters['eval_interval']  # How often to evaluate
